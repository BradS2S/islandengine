defmodule IslandsEngine.Island do
  ...
  def is_hit?(island, guess), do: MapSet.member?(island.coordinates, guess)
  ...
  defp add_coordinates(offsets, %Coordinate{row: row, col: col} = upper_left) do
    Enum.reduce_while(offsets, MapSet.new(), fn {row_offset, col_offset}, acc ->
      add_coordinate(acc, upper_left, {row_offset, col_offset})
    end)
